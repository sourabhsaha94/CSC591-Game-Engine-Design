...
public class Section5Server extends PApplet{
	...
	public void setup(){
		...
		m2.R = new Rectangle(150,300,200,50);

		clientListener.mpList.add(m2);
		
		id = r.nextInt(1000)+1500;
		MovingPlatform m3 = new MovingPlatform(id);
		m3.setPlatformColor(0, 255, 0);
		m3.setPlatformVelocity(1, 0);
		m3.R = new Rectangle(150,700,200,50);

		clientListener.mpList.add(m3);
	...
	public void draw(){
		System.out.println(scl.mpList.size());
