...
public class Section5Server extends PApplet{
	...
	public void setup(){
		...
		clientListener.sPlatformList.add(s1);
		...
		clientListener.sPlatformList.add(s2);
		
		id = r.nextInt(1000)+3000;
		...
		clientListener.mPlatformList.add(m1);
		
		DeathZone downDZ = new DeathZone(5001);
		DeathZone leftDZ = new DeathZone(5002);
		DeathZone rightDZ = new DeathZone(5003);
